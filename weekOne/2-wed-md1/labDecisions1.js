...
if ( temperature >= 80 && rain === true) {
  ...
  console.log( `Wear a jacket its not raining.`)
}
...
// While - as long as z > 0
  // declare a temporary variable and set it to the value of z
  // While  - as long as innerZ > 0
    // print the innerZ
    // decrement the temporary value
  //decrement z
