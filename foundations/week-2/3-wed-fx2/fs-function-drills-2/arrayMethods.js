...
// CODE HERE
const totalPopulation = populations.reduce((total, curPop) => total + curPop);
...
const bobsTotal = purchases.filter(purchase => purchase.owner === "Bob").reduce((priceTotal, currPrice) => priceTotal + currPrice.price, 0);
