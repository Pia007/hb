...
// NOTE: added BY to the imports from selenium-webdriver- was not included in the boilerplate code
...
test('I can search Google', async () => {
    ...
    await searchBar.sendKeys('Hidden Figures\n');
    ...
    await searchBar.sendKeys('Selenium Documentation\n');
