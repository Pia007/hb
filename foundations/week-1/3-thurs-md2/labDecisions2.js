...
if (myFavoriteNumbers.length < 7 ) {
  console.log(`There are not enough elements in this array: ${myFavoriteNumbers}.`);
} else {
...
console.log(`Using a WHILE LOOP and TERNARY OPERATOR`);
let r = 1;

while (r <= 50) {
    console.log(r % 15 ? (r % 5 ? (r % 3 ? r : 'Dev') : 'mountain') : 'Devmountain');
    r++;
}